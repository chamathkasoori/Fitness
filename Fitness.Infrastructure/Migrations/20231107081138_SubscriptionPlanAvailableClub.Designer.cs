...
namespace Fitness.Infrastructure.Migrations
{
    ...
    [Migration("20231107081138_SubscriptionPlanAvailableClub")]
    partial class SubscriptionPlanAvailableClub
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fitness.Core.Entities.SubscriptionPlanAddon", b =>
                {
                    ...
                    b.Property<bool>("AddAllProducts")
                        .HasColumnType("bit");

                    b.Property<int>("ClubServiceTypeId")
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("EndOnLastDayOfMonth")
                        .HasColumnType("bit");
                    ...
                    b.Property<int?>("NumberOfPeriodsForAddProducts")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("PenaltyFeeVatId")
                        .HasColumnType("int");

                    b.Property<int?>("PenaltyLimit")
                        .HasColumnType("int");

                    b.Property<int?>("Quantity")
                        .HasColumnType("int");

                    b.Property<bool>("StartOnFirstDayOfMonth")
                        .HasColumnType("bit");

                    b.HasKey("Id");

                    b.HasIndex("GrossFeeVatId");

                    b.HasIndex("PenaltyFeeVatId");
            ...
            modelBuilder.Entity("Fitness.Core.Entities.SubscriptionPlanClub", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SubscriptionPlanClubs");
                });
            ...
            modelBuilder.Entity("Fitness.Core.Entities.SubscriptionPlanAddon", b =>
                {
                    b.HasOne("Fitness.Core.Entities.Vat", "GrossFeeVat")
                        .WithMany()
                        .HasForeignKey("GrossFeeVatId")
                        .OnDelete(DeleteBehavior.ClientNoAction);

                    b.HasOne("Fitness.Core.Entities.Vat", "PenaltyFeeVat")
                        .WithMany()
                        .HasForeignKey("PenaltyFeeVatId")
                        .OnDelete(DeleteBehavior.ClientNoAction);

                    b.Navigation("GrossFeeVat");

                    b.Navigation("PenaltyFeeVat");
                });
            ...
            modelBuilder.Entity("Fitness.Core.Entities.SubscriptionPlanClub", b =>
                {
                    b.HasOne("Fitness.Core.Entities.Club", "Club")
                        .WithMany("SubscriptionPlanClubs")
                        .HasForeignKey("ClubId")
                        .OnDelete(DeleteBehavior.ClientNoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Fitness.Core.Entities.Club", b =>
                {
                    ...
                    b.Navigation("SubscriptionPlanClubs");
                });
