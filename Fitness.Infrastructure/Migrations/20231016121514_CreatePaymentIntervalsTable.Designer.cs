...
namespace Fitness.Infrastructure.Migrations
{
    ...
    [Migration("20231016121514_CreatePaymentIntervalsTable")]
    partial class CreatePaymentIntervalsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ModuleOperation", b =>
                {
                    ...
                    b.HasKey("ModulesId", "OperationsId");

                    b.HasIndex("OperationsId");

                    b.ToTable("ModuleOperation");
                });
            ...
            modelBuilder.Entity("ModuleOperation", b =>
                {
                    b.HasOne("Fitness.Core.Entities.Module", null)
                        .WithMany()
                        .HasForeignKey("ModulesId")
                        .OnDelete(DeleteBehavior.ClientNoAction)
                        .IsRequired();

                    b.HasOne("Fitness.Core.Entities.Operation", null)
                        .WithMany()
