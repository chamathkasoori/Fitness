...
namespace Fitness.Infrastructure.Migrations
{
    ...
    [Migration("20231216050046_MemberSubscriptionFreeze.MemberSubscriptionAddonId")]
    partial class MemberSubscriptionFreezeMemberSubscriptionAddonId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fitness.Core.Entities.MemberSubscriptionAddon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("MemberSubscriptionAddon");
                });

            modelBuilder.Entity("Fitness.Core.Entities.MemberSubscriptionDiscount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("MemberSubscriptionDiscounts");
                });
            ...
            modelBuilder.Entity("Fitness.Core.Entities.MemberSubscriptionFreeze", b =>
                {
                    ...
                    b.Property<int>("MemberSubscriptionAddonId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Fitness.Core.Entities.SubscriptionPlanAddon", b =>
                {
                    ...
                    b.Property<bool>("IsAvailableForAllPlans")
                        .HasColumnType("bit");
                    ...
                    b.Property<int>("UsageLimitPerPlan")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Fitness.Core.Entities.SubscriptionPlanDiscount", b =>
                {
                    ...
                    b.Property<bool>("OnlyForChoosenApplications")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Fitness.Core.Entities.SubscriptionPlanDiscountCombination", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("CombinedSubscriptionPlanDiscountId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CombinedSubscriptionPlanDiscountId");

                    b.HasIndex("SubscriptionPlanDiscountId");

                    b.ToTable("SubscriptionPlanDiscountCombinations");
                });
            ...
            modelBuilder.Entity("Fitness.Core.Entities.MemberSubscriptionAddon", b =>
                {
                    b.HasOne("Fitness.Core.Entities.MemberSubscription", "MemberSubscription")
                        .WithMany("MemberSubscriptionAddons")
                        .HasForeignKey("MemberSubscriptionId")
                        .OnDelete(DeleteBehavior.ClientNoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Fitness.Core.Entities.MemberSubscriptionDiscount", b =>
                {
                    b.HasOne("Fitness.Core.Entities.MemberSubscription", "MemberSubscription")
                        .WithMany("MemberSubscriptionDiscounts")
                        .HasForeignKey("MemberSubscriptionId")
                        .OnDelete(DeleteBehavior.ClientNoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Fitness.Core.Entities.MemberSubscriptionTransaction", b =>
                {
                    b.HasOne("Fitness.Core.Entities.MemberSubscription", "MemberSubscription")
                        .WithMany("MemberSubscriptionTransactions")
                        .HasForeignKey("MemberSubscriptionId")
                        .OnDelete(DeleteBehavior.ClientNoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Fitness.Core.Entities.SubscriptionPlanDiscountCombination", b =>
                {
                    b.HasOne("Fitness.Core.Entities.SubscriptionPlanDiscount", "CombinedSubscriptionPlanDiscount")
                        .WithMany()
                        .HasForeignKey("CombinedSubscriptionPlanDiscountId")
                        .OnDelete(DeleteBehavior.ClientNoAction)
                        .IsRequired();
                    ...
                    b.Navigation("CombinedSubscriptionPlanDiscount");
            ...
            modelBuilder.Entity("Fitness.Core.Entities.MemberSubscription", b =>
                {
                    ...
                    b.Navigation("MemberSubscriptionAddons");

                    b.Navigation("MemberSubscriptionDiscounts");

                    b.Navigation("MemberSubscriptionFreezes");

                    b.Navigation("MemberSubscriptionTransactions");
                });
