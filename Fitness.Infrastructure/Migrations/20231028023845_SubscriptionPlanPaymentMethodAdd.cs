...
{
    /// <inheritdoc />
    public partial class SubscriptionPlanPaymentMethodAdd : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubscriptionPlanPaymentMethods", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionPlanPaymentMethods_SubscriptionPlanId",
                table: "SubscriptionPlanPaymentMethods",
