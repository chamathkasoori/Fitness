...
namespace Fitness.Infrastructure.Migrations
{
    ...
    [Migration("20231026032047_AddSubscriptionPlanTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fitness.Core.Entities.AssignedSubscriptionPlanClub", b =>
                {
                    ...
                    b.ToTable("AssignedSubscriptionPlanClub");
                });
            ...
            modelBuilder.Entity("Fitness.Core.Entities.SubscriptionPlanPaymentMethod", b =>
                {
                    ...
                    b.ToTable("SubscriptionPlanPaymentMethod");
                });
            ...
            modelBuilder.Entity("Fitness.Core.Entities.SubscriptionPlanVisibility", b =>
                {
                    ...
                    b.ToTable("SubscriptionPlanVisibility");
                });
            ...
            modelBuilder.Entity("SubscriptionPlanTag", b =>
                {
                    ...
                    b.HasKey("SubscriptionPlansId", "TagsId");

                    b.HasIndex("TagsId");

                    b.ToTable("SubscriptionPlanTag");
                });
            ...
            modelBuilder.Entity("Fitness.Core.Entities.AssignedSubscriptionPlanClub", b =>
                {
                    ...
                    b.HasOne("Fitness.Core.Entities.SubscriptionPlan", "SubscriptionPlan")
                        .WithMany("AssignedSubscriptionPlanClubs")
            ...
            modelBuilder.Entity("Fitness.Core.Entities.AvailableSubscriptionPlanClub", b =>
                {
                    ...
                    b.HasOne("Fitness.Core.Entities.SubscriptionPlan", "SubscriptionPlan")
                        .WithMany("AvailableSubscriptionPlanClub")
                        .HasForeignKey("SubscriptionPlanId")
                        .OnDelete(DeleteBehavior.ClientNoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Fitness.Core.Entities.SubscriptionPlan", b =>
                {
                    ...
                    b.HasOne("Fitness.Core.Entities.PaymentPlan", null)
            ...
            modelBuilder.Entity("Fitness.Core.Entities.SubscriptionPlanPaymentMethod", b =>
                {
                    b.HasOne("Fitness.Core.Entities.Club", "PaymentMethod")
                        .WithMany()
                    ...
                    b.HasOne("Fitness.Core.Entities.SubscriptionPlan", "SubscriptionPlan")
                        .WithMany("AssignedPaymentMethods")
                        .HasForeignKey("SubscriptionPlanId")
                        .OnDelete(DeleteBehavior.ClientNoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("SubscriptionPlanTag", b =>
                {
                    b.HasOne("Fitness.Core.Entities.SubscriptionPlan", null)
                        .WithMany()
                        .HasForeignKey("SubscriptionPlansId")
                        .OnDelete(DeleteBehavior.ClientNoAction)
                        .IsRequired();

                    b.HasOne("Fitness.Core.Entities.Tag", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Fitness.Core.Entities.SubscriptionPlan", b =>
                {
                    b.Navigation("AssignedPaymentMethods");

                    b.Navigation("AssignedSubscriptionPlanClubs");

                    b.Navigation("AvailableSubscriptionPlanClub");
